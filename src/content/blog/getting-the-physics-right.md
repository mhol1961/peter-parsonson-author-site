---
title: "Getting the Physics Right in a Thriller"
description: "An EMP is not a magic off-switch. Why a chemist refused to break real physics for a plot beat, and how accuracy makes a thriller scarier, not duller."
excerpt: "The easy version is the one you've seen in a dozen movies: a flash, a hum, and nothing works ever again. That's not what happens. The truth is faster, and worse."
pubDate: 2026-06-05
category: "Craft & Research"
readTime: "8 min read"
image: "/images/getting-the-physics-right-latest-articles.jpg"
---
...
We actually have a real-world preview of all this. In July 1962 the United States detonated a 1.4-megaton warhead about 250 miles above the Pacific, a test called Starfish Prime. Eight hundred-plus miles away in Hawaii, the pulse [knocked out streetlights, tripped burglar alarms, and damaged satellites in orbit](https://en.wikipedia.org/wiki/Starfish_Prime). The effect was so much larger than the physicists predicted that it [drove their own instruments off scale](https://www.aps.org/apsnews/2022/11/electromagnetic-pulse), which means they couldn't even measure what they'd done. Think about that. The people who built the bomb underestimated it. That's not a detail you'd dare invent. Reality already wrote a better scene than I could.
...
This is why I spent twenty-two years on a single novel instead of cranking out three. I corresponded with people who served. I wrote to a former KGB general for the view from the other side, and I once wrote to Tom Clancy, because if you're going to learn a craft you learn it from the people who set the bar. You can read more about [that long stretch of research and the people who shaped it](/about), and about [how I built the operational details to match real procedure](/blog/behind-the-research-authentic-operations).
